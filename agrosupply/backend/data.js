...
export const PRODUCTS = [
  {
    id: 1,
    name: "AgroShield Pro Insecticide",
    category: "Pesticides",
  ...
  {
    id: 4,
    name: "BioDefend Biopesticide",
    category: "Pesticides",
    subcategory: "Biopesticide",
    price: 38.75,
    unit: "500ml",
    brand: "BioDefend",
    sku: "PS-004",
  ...
  {
    id: 5,
    name: "MiteAway Acaricide",
    category: "Pesticides",
    subcategory: "Acaricide",
    price: 47.0,
    unit: "250ml",
    brand: "AgroShield",
    sku: "PS-005",
    ...
    inStock: 40,
    weight: "0.3 kg",
    usage: "Mix 1-2ml per liter of water as a fine mist over both leaf surfaces. Best applied in early morning. Repeat application after 7-10 days if needed.",
    dosage: "1-2ml per liter of water (0.5-1ml per acre)",
  },
  {
    id: 6,
    name: "CropMax NPK 20-20-20",
  ...
  {
    id: 9,
    name: "MicroBoost Trace Elements",
    category: "Fertilizers",
  ...
  {
    id: 11,
    name: "FoliarFeed Liquid Seaweed",
    category: "Fertilizers",
    subcategory: "Biostimulant",
    price: 33.0,
    unit: "1L",
    brand: "OceanGrow",
    sku: "FT-006",
